...
<head>
    ...
    <title>Daftar Pendaftar | ULBI</title>
...
<body>
    ...
    <div class="table-container">
        ...
        <p class="total-data">Total Pendaftar: <?php echo mysqli_num_rows($query) ?><center><a href="index.php" class="back-link"> Kembali ke Menu</a></center></p>
