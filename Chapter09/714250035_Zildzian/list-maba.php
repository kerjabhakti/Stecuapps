...
<head>
    ...
    <link rel="stylesheet" href="list_maba.css">
</head>
<body>
...
<table border="1" cellpadding="8">
    ...
    // PERBAIKAN: Ganti $db menjadi $koneksi sesuai dengan file config.php Anda
    $query = mysqli_query($koneksi, $sql);

    // Cek apakah query berhasil untuk menghindari error saat tabel kosong
    if($query) {
...
<p>Total: <?php echo ($query) ? mysqli_num_rows($query) : 0; ?></p>
